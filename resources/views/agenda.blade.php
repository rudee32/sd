            ...
            <div class="col-lg-8 mx-auto text-center">
                <div class="fade-in">
                    <h1 class="display-3 fw-bold text-white mb-4">
                        <i class="bi bi-calendar-event me-3 text-warning"></i>
                        Agenda
                    </h1>
                    <p class="lead text-white-75 fs-4 mb-5">
                        Jadwal kegiatan dan acara mendatang di sekolah
                    </p>
                </div>
            </div>
        </div>
        ...
        @else
            <div class="text-center py-5">
                <div class="bg-light rounded-4 p-5">
                    ...
                    <p class="text-muted mb-0">Agenda kegiatan akan segera diumumkan. Silakan kembali lagi nanti.</p>
                </div>
            </div>
        @endif
    </div>
