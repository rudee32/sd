            ...
            <div class="col-lg-8 mx-auto text-center">
                <div class="fade-in">
                    <h1 class="display-3 fw-bold text-white mb-4">
                        <i class="bi bi-joystick me-3 text-warning"></i>
                        Edutainment
                    </h1>
                    <p class="lead text-white-75 fs-4 mb-5">
                        Belajar sambil bermain dengan konten edukatif yang menyenangkan dan interaktif
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row g-4 mb-5">
            <div class="col-lg-4 col-md-6">
                <a href="{{ route('edutainment.teka-teki-seru') }}" class="text-decoration-none">
                    <div class="card border-0 shadow-lg h-100 content-card">
                        <div class="card-body p-4 text-center">
                            ...
                            <h5 class="fw-bold text-dark mb-2">Teka-teki Seru</h5>
                            <p class="text-muted mb-0">Kumpulan teka-teki dan puzzle yang mengasah otak dan kreativitas</p>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="{{ route('edutainment.komik-edukasi') }}" class="text-decoration-none">
                    <div class="card border-0 shadow-lg h-100 content-card">
                        <div class="card-body p-4 text-center">
                            ...
                            <h5 class="fw-bold text-dark mb-2">Komik Edukasi</h5>
                            <p class="text-muted mb-0">Komik menarik yang mengajarkan berbagai ilmu pengetahuan</p>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-lg-4 col-md-6">
                <a href="{{ route('edutainment.fun-facts') }}" class="text-decoration-none">
                    <div class="card border-0 shadow-lg h-100 content-card">
                        <div class="card-body p-4 text-center">
                            ...
                            <h5 class="fw-bold text-dark mb-2">Fun Facts</h5>
                            <p class="text-muted mb-0">Fakta-fakta menarik dan mengejutkan dari berbagai bidang ilmu</p>
                        </div>
                    </div>
                </a>
            </div>
                                ...
                                <div class="position-relative overflow-hidden" style="height: 200px;">
                                    ...
                                    <div class="position-absolute top-0 end-0 m-3">
                                        <span class="badge bg-success bg-gradient px-3 py-2 rounded-pill">
                                            <i class="bi bi-joystick me-1"></i>{{ $content->comments->count() }}
                                        </span>
                                    </div>
                                </div>
                            @endif
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="{{ route('content.show', $content->id) }}" class="btn btn-success btn-sm">
                                        <i class="bi bi-arrow-right me-1"></i>Mainkan
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        @else
            <div class="text-center py-5">
                <div class="bg-light rounded-4 p-5">
                    ...
                    <h4 class="text-muted mb-3">Belum Ada Konten Edutainment</h4>
                    <p class="text-muted mb-0">Konten edutainment akan segera hadir. Silakan kembali lagi nanti.</p>
                </div>
            </div>
        @endif
    </div>
