...
@section('title', 'Karya Kita - Kreativitas Siswa')
            ...
            <div class="col-lg-8 mx-auto text-center">
                <div class="fade-in">
                    ...
                    <p class="lead text-white-75 fs-4 mb-5">
                        Koleksi karya kreatif dan inspiratif dari siswa-siswi yang luar biasa
                    </p>
                </div>
            </div>
        </div>
                                ...
                                <div class="position-relative overflow-hidden" style="height: 200px;">
                                    ...
                                    <div class="position-absolute top-0 end-0 m-3">
                                        <span class="badge bg-primary bg-gradient px-3 py-2 rounded-pill">
                                            <i class="bi bi-star me-1"></i>{{ $content->comments->count() }}
                                        </span>
                                    </div>
                                </div>
                            @endif
        ...
        @else
            <div class="text-center py-5">
                <div class="bg-light rounded-4 p-5">
                    ...
                    <h4 class="text-muted mb-3">Belum Ada Karya Siswa</h4>
                    <p class="text-muted mb-0">Karya siswa akan segera ditampilkan. Silakan kembali lagi nanti.</p>
                </div>
            </div>
        @endif

        <div class="mt-5 text-center">
            <a href="{{ route('kreativitas-siswa') }}" class="btn btn-outline-primary">
                <i class="bi bi-arrow-left me-2"></i> Kembali ke Kreativitas Siswa
            </a>
        </div>
    </div>
</section>
