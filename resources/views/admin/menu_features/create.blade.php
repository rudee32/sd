...
@section('title', 'Tambah Menu Feature')

@section('content')
<div class="container my-5">
    <h1>Tambah Menu Feature</h1>

    <form action="{{ route('admin.menu_features.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <a href="{{ route('admin.menu_features.index') }}" class="btn btn-secondary">Batal</a>
    </form>
</div>
@endsection
