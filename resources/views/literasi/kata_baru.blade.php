...
@section('title', 'Kata Baru - Literasi Corner')

@section('content')
<div class="container my-5">
    <h1 class="mb-4"><i class="bi bi-chat-left-text"></i> Kata Baru</h1>
    <p class="text-muted mb-4">Perluasan kosakata dengan kata-kata baru dan menarik. Temukan berbagai kata baru yang dapat memperkaya kosakata dan meningkatkan kemampuan berbahasa siswa.</p>
    ...
    @else
        <div class="text-center py-5">
            ...
            <h3 class="mt-3 text-muted">Belum ada kata baru tersedia</h3>
            <p class="text-muted">Kata baru akan segera ditambahkan.</p>
        </div>
    @endif
